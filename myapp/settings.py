...
SECRET_KEY = 'django-insecure-)#g*ogu@*+7q(0(*gx8-8_at--9q=x8sov2=%0$3%n^tkhvmki'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication',     # Аутентификация по jwt токенам
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),   # Это слово должно фигурировать перед JWT-токеном при авторизации
